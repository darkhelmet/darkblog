...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".document",
     ...
     "lib/sinatra/markup_plugin/form_builder/abstract_form_builder.rb",
     "lib/sinatra/markup_plugin/form_builder/standard_form_builder.rb",
