...
module Sinatra
  module WardenPlugin
    ...
    class PasswordStrategy < Warden::Strategies::Base
      ...
      def authenticate!
        raise "Please either define a user class or set Sinatra::WardenPlugin::PasswordStrategy.user_class" unless user_class
    ...
    def self.registered(app)
      ...
      app.helpers Sinatra::MarkupPlugin::OutputHelpers
      app.helpers WardenHelpers
